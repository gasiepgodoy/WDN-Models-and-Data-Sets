...
for folders in range(len(namelist)):   
    ...
    data['P141'] = data['P14'] - data['P2']
    data['P151'] = data['P15'] - data['P2']
    data['P161'] = data['P16'] - data['P2']
    data['P171'] = data['P17'] - data['P2']
    data['P181'] = data['P18'] - data['P2']
    data['P191'] = data['P19'] - data['P2']
    data['P201'] = data['P20'] - data['P2']
