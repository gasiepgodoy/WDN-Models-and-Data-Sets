## gerar o dataset com juntas zeradas
import numpy as np
import pandas as pd
import torch
import natsort
...
dataPath = os.path.join(parentDirectory, 'Original_Data')   
#
print('pdataPath=', dataPath)


newPath = os.path.join(fileDirectory,'Original_Data' ) 
...
folderPath = os.path.join(fileDirectory, 'work_dirjz')   
...
for folders in range(len(namelist)):   
    ...
    data['P101'] = data['P10'] - data['P2']
    data['P111'] = data['P11'] - data['P2']
    data['P121'] = data['P12'] - data['P2']
    data['P131'] = data['P13'] - data['P2']
    data['P141'] = 0 #data['P14'] - data['P2']
    data['P151'] = 0 #data['P15'] - data['P2']
    data['P161'] = 0 #data['P16'] - data['P2']
    data['P171'] = 0 #data['P17'] - data['P2']
    data['P181'] = 0 #data['P18'] - data['P2']
    data['P191'] = 0 #data['P19'] - data['P2']
    data['P201'] = 0 #data['P20'] - data['P2']
